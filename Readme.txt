...
Really Bad Eggs features two basic game types.  The first is a single-player
...
chains is related to the number of points earned for those chains, so creating
